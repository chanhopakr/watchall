...
Ext.define('apps.ux.grid.OperatorButton', {
  ...
  init: function(textField) {
    ...
    Ext.each(me.operators, function(op) {
      items.push(
        Ext.apply(Ext.clone(me.operatorSet[op]), {
  ...
  onFieldMouseOver: function(e) {
    ...
    if (e.getRelatedTarget() == me.operatorButtonEl.dom) {
      ...
      me.operatorButtonEl.removeCls(
        me.operatorButtonCls + '-mouse-over-button'
      );
