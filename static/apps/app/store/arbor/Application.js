Ext.define('apps.store.arbor.Application', {
  extend: 'Ext.data.Store',
  alias: 'store.arbor.application',
  ...
  proxy: {
    ...
    data: [
      ...
      ['24', 'dhcp', 'Dynamic Host Configuration Protocol (BOOTP)'],
      ...
      [
        '32',
        'gnutella',
        'Peer to peer filesharing (BearShare/Gnucleus/LimeWire/Shareaza)'
      ],
      ...
      [
        '24000',
        'other TCP',
        'TCP Traffic that is not classified as any other application'
      ],
      [
        '24001',
        'other UDP',
        'UDP Traffic that is not classified as any other application'
      ],
