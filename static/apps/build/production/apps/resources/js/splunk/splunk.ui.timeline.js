...
(function() {
    ...
    root.Timeline = Class.extend({
        // XXX patched
        //init: function(el) {
        init: function(el, externalInterface) {
            //this.timeline = new SplunkTimeline();
            this.timeline = new SplunkTimeline(externalInterface); // format -> externalInterface
...
(function() {
	...
	jg_namespace("splunk", function()
	{
		...
		this.Timeline = jg_extend(VisualObject, function(Timeline, base)
		{
			...
			this.constructor = function(externalInterface, hostPath, basePath)
			{
			...
			this._rangeFormat = function(minimum, maximum)
			{
                ...
                // XXX patched
				var format = this.externalInterface.formatRange;
